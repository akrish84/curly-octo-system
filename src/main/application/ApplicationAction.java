...
public class ApplicationAction {
	...
	private Map<Long, JobApplicationStatus> statusesMap;
	...
	public String fetchUserStatuses() {
		...
		try {
			...
			statusesMap = JobApplicationHandler.fetchJobApplicationStatusesForUser(userID);
		}catch(Exception e) {
	...
	public String fetchUserApplications() {
		...
		try {
			userID = SessionHandler.getLoggedInUserID();
			applications = JobApplicationHandler.fetchUserJobApplications(userID);
		}catch(Exception e) {
	...
	public String addStatus() {
		...
		try {
			...
			JobApplicationHandler.addJobStatusForUser(status, userID);
		} catch(Exception e) {
	...
	public String updateStatus() {
		...
		try {
			...
			JobApplicationHandler.updateJobStatusForUser(status, userID);
		} catch(Exception e) {
			LOGGER.log(Level.SEVERE, "Failed to add status for user " + userID, e);
			responseMessage = Utils.getErrorMessage("Failed to add status for user");
		}
	...
	public String updateStatuses() {
		...
		try {
			...
			JobApplicationHandler.updateJobStatusesForUser(statuses, userID);
		} catch(Exception e) {
			LOGGER.log(Level.SEVERE, "Failed to add status for user " + userID, e);
	...
	public String updateApplication() {
		...
		try {
			...
			JobApplicationHandler.updateJobApplication(userID, applicationID, newStatusID, applicationIDs);
		} catch(Exception e) {
	...
	public Map<Long, JobApplicationStatus> getStatusesMap() {
		return statusesMap;
	}

	public void setStatusesMap(Map<Long, JobApplicationStatus> statusesMap) {
