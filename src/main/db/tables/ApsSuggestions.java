...
public class ApsSuggestions {

	
	
	private static final String INSERT_APS_FOR_SUGGESTION = "main.db.tables.ApsSuggestionsTable.insertApsForSuggestion";
	private static final String GET_APS_SUGGESTIONS = "main.db.tables.ApsSuggestionsTable.getApsSuggestions";
	 ...
	 * @throws SQLException
	 */
	public static List<String> getApsSuggestions() throws SQLException {
		Connection connection = DataSourceConnector.getConnection();
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        List<String> suggestions = new ArrayList<>();
        try {
	        statement = connection.prepareStatement(QueryProvider.getQuery(GET_APS_SUGGESTIONS));
