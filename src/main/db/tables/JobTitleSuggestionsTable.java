...
public class JobTitleSuggestionsTable {
	...
	private static String GET_JOB_TITLE_SUGGESTIONS = "main.db.tables.JobTitleSuggestionsTable.fetchJobTitleSuggestions";
	 ...
	 * @throws SQLException
	 */
	public static List<String> getJobTitleSuggestions() throws SQLException {
		Connection connection = DataSourceConnector.getConnection();
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        List<String> suggestions = new ArrayList<>();
        try {
	        statement = connection.prepareStatement(QueryProvider.getQuery(GET_JOB_TITLE_SUGGESTIONS));
